...
- Objetivo: `/api/v1/status` retornar valores relevantes
- Cobertura de testes automatizados

## Slow-Track: Endpoint status ISO 8601 + Fuso + MVC + lowerCamelCase

- Horário em formato ISO 8601
  - ANO-MES-DIA[T]HORA:MINUTO:SEGUNDO[LETRA_DE_FUSO]
  - 2023-11120T13:37:54Z
  - A **LETRA_DE_FUSO** é dada pelo Military Time Zone
    - Alfa Time Zone (A): UTC+01:00
    - Beta Time Zone (B): UTC+02:00
    - ...
    - Zulu Time Zone (Z): UTC+00:00

### Como pensar a Arquitetura MVC

Siga o seguinte fluxo:

```
Controller -> Model -> Controller -> View
```

- **Controller** é onde a requisição bate primeiro no nosso sistema
  - Não serve para computar nada
  - Ele só serve para acessar as ferramentas presentes no **Model**
  - Depois de consumir os dados do **Model**, ele devolve seus resultados para a **View**
  - Controla operações entre um ou vários **Models**
- Quando precisa-se computar algo, chamamos o **Model**
  - Computa tudo
  - Executa regras de negócio
  - Roda engrenagens do sistema
    - Depois de computar devolve para a **View**
  - Possibilita reaproveitamento de código
- **View** se responsabiliza em mostrar para o usuário final
  - No nosso caso, em json
  - Devolvem ao usuário

## Slow-Track: Queries Parametrizadas

3 Tipos de Queries:

- Queries sem parâmetros
  - Não é passível de SQL Injection
  - `SHOW server_version;`
  - `SHOW max_connections;`
- Queries com parâmetros fixos
  - Não é passível de SQL Injection
  - Seus parâmetros já estão embuídos no código
  - `SELECT * FROM pg_stat_activity WHERE datname = 'local_db';`
- Queries com parâmetros dinâmicos
  - Passível de SQL Injection
  - Mais flexíveis
    - Mais comuns
